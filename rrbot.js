...
class RRBOT extends ActivityHandler {
    ...
    async sendWelcomeMessage(turnContext) {
        ...
        for(const id in activity.membersAdded){
            ...
            if(activity.membersAdded[id].id!==activity.recipient.id){
             ...
             await turnContext.sendActivity(`Welcome to R bot ${ activity.membersAdded[id].name }. `);
    ...
    async sendSuggestedActions(context) {
        var reply = MessageFactory.suggestedActions(['Add employee','Cancel Reservation','Restaurant Address'],'What would you like to do today ?');
